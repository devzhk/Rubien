...
| Science / AAAS | `www.science.org` | `/doi/10.1126/<suffix>`, `/doi/full/10.1126/<suffix>`, or `/doi/abs/10.1126/<suffix>` | `/doi/pdf/10.1126/<suffix>?download=true` (download) or `/doi/epdf/10.1126/<suffix>` (viewer) |
...
| Oxford Academic journals | `academic.oup.com` | `/<journal>/article/<volume>/<issue>/<first-page>/<article-id>`, the corresponding `article-abstract` path, or DOI-bearing `article` / `advance-article` variants | `/<journal>/article-pdf/<volume>/<issue>/<first-page>/<asset-id>/<filename>.pdf`; the browser extension associates it by the stable article locator, while direct PDF URLs remain remote-file imports |
| GeoscienceWorld journals | `pubs.geoscienceworld.org` | `/<society>/<journal>/article/<volume>/<issue>/<first-page>/<article-id>/<title>` (the society segment may be omitted) or the corresponding `article-abstract` path | `/<society>/<journal>/article-pdf/<volume>/<issue>/<first-page>/<asset-id>/<filename>.pdf` (the society segment may be omitted); Rubien validates the stable issue locator, and direct PDF URLs remain remote-file imports |
