...
> (2026-07-15):** Settings now includes a default-off **Use connected apps and MCP
> tools** option. New Claude conversations omit settings/strict-MCP isolation when
> enabled; new Codex conversations omit `--disable apps`. Both retain Rubien's MCP
> channel and approval transport.
